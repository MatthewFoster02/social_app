...
This was a basic introduction to the contents and structure of the backend folder. The API documentation, automatically generated by FastAPI for the routes mentioned above can be found [here]().
